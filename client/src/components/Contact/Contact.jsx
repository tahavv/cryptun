          ...
          <div className="screen-body">
            <div className="screen-body-item left">
              ...
              <div className="app-contact">
                <a href="https://fb.com/taha.2y" ><img className="social-media" src={Fb} alt="" /></a>
                <a href="https://www.instagram.com/tahaayari.exe/" ><img className="social-media" src={Instagram} alt="" /></a>
                <a href="https://twitter.com/tahaayari3" ><img className="social-media" src={Twitter} alt="" /></a>
                <a href="https://www.linkedin.com/in/taha-ayari-090a0b199" ><img className="social-media" src={Linkedin} alt="" /></a>
              </div>
            </div>
